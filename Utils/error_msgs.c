...
/*   Updated: 2021/03/27 19:27:29 by gdelta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	config_elements_check(t_win *window_config)
{
	...
	|| !window_config->no_tex || !window_config->so_tex
	|| !window_config->ea_tex || !window_config->we_tex
	|| !window_config->sprite_tex || !window_config->ceiling_color
	|| !window_config->floor_color)
		return (0);
	return (1);
}
